...
public class DataCreationTest extends BasePage {
    ...
    public void createNewRsmAsmMrUsers(){
        ...
        String MRName = Name+" MR PMNDQA";
        String MREmail = Name+"mrPMNDQA@yopmail.com";
        String ASMName = Name+" Asm PMNDQA";
        String ASMEmail = Name+"asmPMNDQA@yopmail.com";
        String RSMName = Name+" Rsm PMNDQA";
        String RSMEmail = Name+"rsmPMNDQA@yopmail.com";
        ...
        dataCreationPage.createNewUser(RSMName, RSMEmail, "RSM PMNDQA");
        dataCreationPage.addIntoAccountListRSM(RSMEmail,RSMName);
        dataCreationPage.createNewUser(ASMName, ASMEmail, "ASM PMNDQA");
        dataCreationPage.addIntoAccountListASM(ASMEmail, ASMName, RSMName);
        dataCreationPage.createNewUser(MRName, MREmail, "MR PMNDQA");
