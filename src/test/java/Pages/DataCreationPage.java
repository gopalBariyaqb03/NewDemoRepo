...
public class DataCreationPage extends Locators {
    ...
    public void loginWithDirectorsUsers(){
        ...
        if (common.isElementDisplayed(USERNAMEFIELD)) {
            ...
            common.type(USERNAMEFIELD,"director@gmail.com");
...
//    }
    ...
    public void createHolidayUsingAdminCredencials(String HolidayName) throws ParseException {
        ...
        Date startDate = formatter.parse("01/01/2026");
        Date endDate = formatter.parse("31/12/2027");
...
//        common.type(EXPECTEDVISITINP,"1");
    ...
    public void addDoctorQualificationInAttributes(String qualificationName){
...
//        driver.findElement(By.xpath(SEARCHFIELDINDASH)).clear();
        ...
        common.logPrint("Step:: Click on the Doctor qualification");
        common.waitUntilElementToBeVisible(By.xpath(DOCTORQUALIFICATION));
        common.click(DOCTORQUALIFICATION);

        common.logPrint("Step:: Click on the add button");
        common.waitUntilElementToBeVisible(By.xpath(ADDBTN));
        common.click(ADDBTN);

        common.logPrint("Step:: Enter qualification name");
        common.waitUntilElementToBeVisible(By.xpath(QUALIFICATIONINPATT));
        common.type(QUALIFICATIONINPATT,qualificationName);
